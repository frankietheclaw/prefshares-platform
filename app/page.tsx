        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block">Canadian Preferred Shares</span>
              <span className="block text-primary-600">Complete Database & Analysis</span>
            </h1>
      ...
      <footer className="bg-gray-800">
        <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
          <p className="text-center text-base text-gray-400">
            © 2026 PrefShares.ca. Data is for informational purposes only. Not investment advice.
          </p>
        </div>
      </footer>
    </>
